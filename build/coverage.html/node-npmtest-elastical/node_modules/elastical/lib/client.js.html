...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-elastical/node_modules/elastical/lib/client.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-elastical/node_modules/elastical/lib/client.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-elastical/node_modules/elastical/lib/</a> &#187; client.js</div>
</div>
<div class="body">
...
@constructor
**/
<span class="fstat-no" title="function not covered" >function Client(host, options) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.host    = host || '127.0.0.1';</span>
<span class="cstat-no" title="statement not covered" >    this.options = options || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if(typeof this.options.port === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >      this.options.port = 9200;</span>
    }
    else <span class="cstat-no" title="statement not covered" >if(this.options.port === null) {</span>
<span class="cstat-no" title="statement not covered" >      this.options.port = null;</span>
    }
<span class="cstat-no" title="statement not covered" >    this.options.protocol || (this.options.protocol = 'http');</span>
<span class="cstat-no" title="statement not covered" >    this.options.timeout || (this.options.timeout = 60000);</span>
<span class="cstat-no" title="statement not covered" >    this.options.basePath || (this.options.basePath = null);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._indexCache = {};</span>
}
&nbsp;
Client.prototype = {
    ...
    **/
    get baseUrl() {
        var baseUrl = this.options.protocol + '://' +
            ...
            this.host;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if(this.options.port !== null) {</span>
<span class="cstat-no" title="statement not covered" >          baseUrl = baseUrl + ':' + this.options.port;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if(this.options.basePath !== null) {</span>
<span class="cstat-no" title="statement not covered" >          baseUrl = baseUrl + this.options.basePath;</span>
        }
...
&nbsp;
    ...
    @see Index.count
    **/
    count: <span class="fstat-no" title="function not covered" >function (options, callback) {</span>
...
<span class="cstat-no" title="statement not covered" >          var err =  new Error("callback is not a function");</span>
...
<span class="cstat-no" title="statement not covered" >        options = util.merge(options || {});</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (options.index) {</span>
<span class="cstat-no" title="statement not covered" >            url = '/' + encode(Array.isArray(options.index) ?</span>
...
<span class="cstat-no" title="statement not covered" >        if (typeof options.query === 'string') {</span>
<span class="cstat-no" title="statement not covered" >            options = {query_string: {query: options.query}};</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                url = '/_all';</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            url += '/' + encode(Array.isArray(options.type) ?</span>
                options.type.join(',') : options.type);
&nbsp;
<span class="cstat-no" title="statement not covered" >            delete options.type;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        hasOptions = !!Object.keys(options).length;</span>
<span class="cstat-no" title="statement not covered" >        url += '/_count';</span>
<span class="cstat-no" title="statement not covered" >        options.curlDebug = true;</span>
<span class="cstat-no" title="statement not covered" >        var myOptions = { method: hasOptions ? 'POST' : 'GET'};</span>
<span class="cstat-no" title="statement not covered" >        if(hasOptions){</span>
<span class="cstat-no" title="statement not covered" >          myOptions.json = options;</span>
        }
<span class="cstat-no" title="statement not covered" >        this._request(url, myOptions, <span class="fstat-no" title="function not covered" >function (err, res) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (err) { </span>
<span class="cstat-no" title="statement not covered" >              return callback(err, null, res), undefined; </span>
            }
<span class="cstat-no" title="statement not covered" >            if(res._shards.failed &gt; 0){</span>
<span class="cstat-no" title="statement not covered" >              return callback(new Error(res._shards.failures.reason), null, res), undefined;</span>
            }
<span class="cstat-no" title="statement not covered" >            return callback(null, res.count, res);</span>
        });
    },
&nbsp;
    /**
...
&nbsp;
    ...
    @see Index
    **/
    getIndex: <span class="fstat-no" title="function not covered" >function (name) {</span>
<span class="cstat-no" title="statement not covered" >        return this._indexCache[name] ||</span>
...
<span class="cstat-no" title="statement not covered" >        var useScrollingEndpoint = (options.scroll_id != null);</span>
        // Create a copy of options so we can modify it.
<span class="cstat-no" title="statement not covered" >        options = util.merge(options || {});</span>
&nbsp;
        // Some options must be passed as query parameters. Find those options
        // and move them into the query param array.
<span class="cstat-no" title="statement not covered" >        this._SEARCH_PARAMS.forEach(<span class="fstat-no" title="function not covered" >function (name) {</span></span>
...
<span class="cstat-no" title="statement not covered" >                    query.push(encode(name) + '=' + (value ? '1' : '0'));</span>
                } else {
...
<span class="cstat-no" title="statement not covered" >            options.fields = Array.isArray(options.fields) ? options.fields :</span>
                [options.fields];
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (options.index) {</span>
...
&nbsp;
        ...
        // a query_string query.
<span class="cstat-no" title="statement not covered" >        if (typeof options.query === 'string') {</span>
<span class="cstat-no" title="statement not covered" >            options.query = {query_string: {query: options.query}};</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (options.type) {</span>
<span class="cstat-no" title="statement not covered" >            if (!url) {</span>
...
<span class="cstat-no" title="statement not covered" >        hasOptions = !!Object.keys(options).length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        url += '/_search';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if(useScrollingEndpoint){</span>
<span class="cstat-no" title="statement not covered" >          url += '/scroll';</span>
        }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        this._request(url, {</span>
...
<span class="cstat-no" title="statement not covered" >            callback(null, res.hits, res);</span>
        });
    },
...
<span class="cstat-no" title="statement not covered" >        if (options.types) {</span>
<span class="cstat-no" title="statement not covered" >          query.push(encode('types') + '=' + encode(Array.isArray(options.types) ?</span>
            options.types.join(',') : options.types));
        }
<span class="cstat-no" title="statement not covered" >        delete options.types;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      url += '/_stats';  </span>
&nbsp;
...
&nbsp;
    ...
    @protected
    **/
    _request: <span class="fstat-no" title="function not covered" >function (path, options, callback) {</span>
<span class="cstat-no" title="statement not covered" >        var url = this.baseUrl + path;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (typeof options === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            callback = options;</span>
<span class="cstat-no" title="statement not covered" >            options  = {};</span>
...
<span class="cstat-no" title="statement not covered" >        [ 'timeout',</span>
          ...
          'oauth',
          'strictSSL',
          'jar'].forEach(<span class="fstat-no" title="function not covered" >function(key){</span>
<span class="cstat-no" title="statement not covered" >          if(this.options[key] == null) <span class="cstat-no" title="statement not covered" >return</span></span>
<span class="cstat-no" title="statement not covered" >          options[key] || (options[key] = this.options[key]);</span>
        }, this);
&nbsp;
        // Write executable curl commands to stderr for easier debugging when
        // this client's curlDebug option is true.
<span class="cstat-no" title="statement not covered" >        if (this.options.curlDebug) {</span>
<span class="cstat-no" title="statement not covered" >            curlDebug(options);</span>
        }
&nbsp;
        // Provide a testing hook to allow inspection of the request options
        // without actually sending a request.
<span class="cstat-no" title="statement not covered" >        if (this._testHook) {</span>
<span class="cstat-no" title="statement not covered" >            return this._testHook(null, options), undefined;</span>
        }
<span class="cstat-no" title="statement not covered" >        request(url, options, <span class="fstat-no" title="function not covered" >function (err, res, body) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (err) { <span class="cstat-no" title="statement not covered" >return callback(err), undefined; </span>}</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            if (typeof body === 'string' || body instanceof Buffer) {</span>
<span class="cstat-no" title="statement not covered" >                body = body.toString('utf8');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                callback(Error((body &amp;&amp; body.error) || 'HTTP ' + res.statusCode),</span>
                    body || {});
...
&nbsp;
<span class="fstat-no" title="function not covered" >function curlDebug(options) {</span>
<span class="cstat-no" title="statement not covered" >    var command = 'curl -X' + (options.method || 'GET');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    command += " '" + options.uri + "'";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (options.body) {</span>
<span class="cstat-no" title="statement not covered" >        command += " --data-binary '" + options.body + "'";</span>
    } else <span class="cstat-no" title="statement not covered" >if (options.json) {</span>
<span class="cstat-no" title="statement not covered" >        command += " -d '" + JSON.stringify(options.json, null, 2) + "'";</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    process.stdout.write(command + '\n');</span>
}
&nbsp;
function wrapIndexMethod(methodName) {
    return <span class="fstat-no" title="function not covered" >function (indexName) {</span>
<span class="cstat-no" title="statement not covered" >        var args  = Array.prototype.slice.call(arguments, 1),</span>
            index = this.getIndex(indexName);
&nbsp;
<span class="cstat-no" title="statement not covered" >        return index[methodName].apply(index, args);</span>
    };
}
&nbsp;
